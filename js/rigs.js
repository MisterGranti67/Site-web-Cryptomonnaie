...
=======
                    var etat = "<span style=\"color:#0A9200;margin-left: 37px\">" + nombre + "%</span><a href=\"#\" style=\"text-direction: none\" onclick=\"ajouter_au_technicien('"+ pseudo + "','"+ code + "', " + id + ", " + data_rig["cartes_graphique"][i]["id"] + ")\"><span class=\"reparation\">🔨</span></a>"
                }
            } else {
                if (nombre > 90){
                    var etat = "<span style=\"color:#990000;margin-left: 37px\">" + nombre + "%</span><a href=\"#\" style=\"text-direction: none\" onclick=\"ajouter_au_technicien('"+ pseudo + "','"+ code + "', " + id + ", " + data_rig["cartes_graphique"][i]["id"] + ")\"><span class=\"reparation\">🔨</span></a>"
                } else if (nombre > 70) {
                    var etat = "<span style=\"color:#FF3300;margin-left: 37px\">" + nombre + "%</span><a href=\"#\" style=\"text-direction: none\" onclick=\"ajouter_au_technicien('"+ pseudo + "','"+ code + "', " + id + ", " + data_rig["cartes_graphique"][i]["id"] + ")\"><span class=\"reparation\">🔨</span></a>"
                } else {
                    var etat = "<span style=\"color:#FF8E00;margin-left: 37px\">" + nombre + "%</span><a href=\"#\" style=\"text-direction: none\" onclick=\"ajouter_au_technicien('"+ pseudo + "','"+ code + "', " + id + ", " + data_rig["cartes_graphique"][i]["id"] + ")\"><span class=\"reparation\">🔨</span></a>"
>>>>>>> ebe4ce1c807f59fc7d6beb38addddf3ba9e123ab
                }
            }
